...
#' diagnostics for random effects, and standardized indices to help understand model structure
...
#' - **Statistical Rigor**: Proper confidence intervals, geometric mean calculations, family-appropriate aggregation
...
#' - `plot_standardisation()`: Compare unstandardized vs standardized indices
...
#' - `plot_terms()`: Predicted effects visualization
...
#' standardizations" (ICES Journal of Marine Science).
#'
#' @references
#' Bentley, N., Kendrick, T. H., Starr, P. J., & Breen, P. A. (2012).
#' Influence plots and metrics: tools for better understanding fisheries catch-per-unit-effort standardizations.
